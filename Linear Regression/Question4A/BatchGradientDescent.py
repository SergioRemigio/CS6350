...
This file contains the implementation of the Batch Gradient Descent Algorithm.
...
def get_gradient_of_loss_function_wt(wt, training_examples):
    ...
    for j in range(num_of_features):
        ...
        for i in training_examples:
            ...
            yi = float(training_examples[0][len(i) - 1])
...
def batch_gradient_descent(tolerance_level, learning_rate, initial_r, initial_wt, training_examples, test_examples):
    """
...
if __name__ == "__main__":
    ...
    batch_gradient_descent(tolerance_level, learning_rate, initial_r, initial_wt, training_examples, test_examples)
